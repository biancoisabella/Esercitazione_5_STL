...
int main()
{
    ...
    // controllo se esistono degli archi di lunghezza pari a 0
    for (auto id:mesh.Cell1DsId){
        if (mesh.isZeroEdge(id))
            cerr << "Il nodo " << id << " ha lunghezza pari a 0!" << endl;
    }

    // controllo se esistono poligoni di area pari a 0
    for (auto id:mesh.Cell2DsId){
        if (mesh.isZeroArea(id))
            cerr << "Il poligono " << id << "ha area pari a 0!" << endl;
    }
